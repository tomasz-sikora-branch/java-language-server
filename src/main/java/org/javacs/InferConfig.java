...
class InferConfig {
    ...
    private Set<Path> bazelClasspath(Path bazelWorkspaceRoot) {
        ...
        for (var relative :
                bazelAQuery(bazelWorkspaceRoot, "Javac", "--classpath", "java_library", "java_test", "java_binary", "branch_java_test", "branch_java_library", "branch_java_binary", "branch_java_group")) {
            absolute.add(bazelWorkspaceRoot.resolve(relative));
        }
        return absolute;
    }
    ...
    private Set<Path> bazelSourcepath(Path bazelWorkspaceRoot) {
        ...
        for (var relative :
                bazelAQuery(
                        bazelWorkspaceRoot, "JavaSourceJar", "--sources", "java_library", "java_test", "java_binary", "branch_java_test", "branch_java_library", "branch_java_binary", "branch_java_group")) {
